...
public class ReaderActivity extends Activity 
{
	...
	public int epcEpcWidth=0;
	public int epcDataWidth=0;
	public int epcCountWidth=0;
	public int epcAntWidth=0;
    public int epcTimeWidth=0;
	...
	{
		rowNumberWidth=(int) (windowWidth*(0.1));
		epcEpcWidth=(int) (windowWidth*(0.3));
		epcAntWidth=(int) (windowWidth*(0.1));
        epcTimeWidth = (int) (windowWidth*(0.2));
	...
	private void findAllViewsById() 
	{
		...
		rowNumberLabelView = (TextView) findViewById(R.id.NumberLabel);
		epcEpcLabelView = (TextView) findViewById(R.id.EPCLabel);
		epcAntLabelView = (TextView) findViewById(R.id.AntennaLabel);
		epcCountLabelView = (TextView) findViewById(R.id.ReadConutLabel);
		epcDataLabelView = (TextView) findViewById(R.id.DataLabel);
        epcTimeLabelView = (TextView) findViewById(R.id.TimeStampLabel);
